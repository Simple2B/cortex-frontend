  ...
  return (
    <div className="menuInfoPatient_container">
      <div className="menuInfoPatient">
        <div
          className={
            splitLocation[splitLocation.length - 1] === `${client.firstName}`
              ? "active"
              : "menuInfoPatientItem"
          }
        >
          <NavLink to={`/${api_key}/${client.firstName}`} className="item">
            {client.firstName + " " + client.lastName.split("")[0] + "."}
          </NavLink>
        </div>
        <div
          className={
            splitLocation[splitLocation.length - 1] === "care_plane"
              ? "active"
              : "menuInfoPatientItem"
          }
        >
        ...
        <div
          className={
            splitLocation[splitLocation.length - 1] === "notes"
              ? "active"
              : "menuInfoPatientItem"
          }
        >
        ...
        <div
          className={
            splitLocation[splitLocation.length - 1] === "intake"
              ? "active"
              : "menuInfoPatientItem"
          }
        >
        ...
        <div
          className={
            splitLocation[splitLocation.length - 1] === "account"
              ? "active"
              : "menuInfoPatientItem"
          }
        >
