...
export default function NavBar(): ReactElement {
  ...
  return (
    <div className="nav_bar">
      <div onClick={handleMenuSwitch} className="menu_button">
        <Menu />
      </div>
      <nav className={`menu ${switchMenu ? "open" : ""}`}>
        <NavLink
          ...
          to="/patients"
          onClick={() =>
            splitLocation[splitLocation.length - 1] === "patients" &&
            setSwitchMenu(false)
          }
        >
          Patients
        ...
        <NavLink
          ...
          to="/reports"
          onClick={() =>
            splitLocation[splitLocation.length - 1] === "reports" &&
            setSwitchMenu(false)
          }
        >
          Reports
        </NavLink>
        <NavLink className="nav_item" to="/kiosk">
          Kiosk
        </NavLink>
        <NavLink onClick={handlerLogout} className="nav_item" to="/">
          Log out
        </NavLink>
      </nav>
      <div
